...
public class JwkServiceNimbusImpl implements JwkService {
    ...
    public JwkServiceNimbusImpl(
            final String url, Set<String> requiredClaims, String algorithm, String type) {
        try {
            ...
            JWSKeySelector<SecurityContext> keySelector =
                    new JWSVerificationKeySelector<>(JWSAlgorithm.parse(algorithm), keySource);

            jwtProcessor.setJWSKeySelector(keySelector);
            jwtProcessor.setJWTClaimsSetVerifier(
                    new DefaultJWTClaimsVerifier<>(
                            new JWTClaimsSet.Builder().build(), requiredClaims));
    ...
    @Override
    public PrincipleUser process(String idToken)
        ...
        try {
            ...
            // TODO don't pass "null like this" either create a new impl without null or find a
            // workaround
            return new PrincipleUser(
                    "null", authorities, userId, (String) claimsSet.getClaim("email"));
